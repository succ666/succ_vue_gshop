    ...
    <div class="msite">
      ...
      <HeaderTop :title="address.name || '正在定位中...'">
        ...
        <span class="header_login" slot="right">
          <span class="header_login_text" :class="userInfo._id?'iconfont icon-phone':''">{{userInfo._id? '':'登录|注册'}}</span>
        </span>
      </HeaderTop>
      <!--首页导航-->
      <nav class="msite_nav">
        <div class="swiper-container">
          <div class="swiper-wrapper" v-if="categoryArr.length>0">
          ...
          <div v-else>
              <img src="./images/msite_back.svg" alt="loaging...">
          </div>
